...
#   2. python scripts/10_build_rag_index.py  → construit l'index vectoriel
#   3. ANTHROPIC_API_KEY dans le .env
#
# Usage :
#   python scripts/11_rag_credibility.py                           → mode interactif
#   python scripts/11_rag_credibility.py "Texte de la news ici."  → argument direct
#   python scripts/11_rag_credibility.py --top-k 8 "Texte..."    → top-k personnalisé
...
sys.path.insert(0, __file__.replace("11_rag_credibility.py", ""))
